...
public class Brigitte extends HeroSpecific {
    float healingDone;

    public Brigitte(String heroName, float deaths, float dmg, float kills, float assists, float healingDone, float elimsPerLife, Time time, int gamesPlayed, int gamesWon, int gamesLost) {
