...
public class Lucio extends HeroSpecific {
    float healingDone;
    float critHits;

    public Lucio(String heroName, float critHits, float deaths, float dmg, float kills, float assists, float healingDone, float elimsPerLife, Time time, int gamesPlayed, int gamesWon, int gamesLost) {
