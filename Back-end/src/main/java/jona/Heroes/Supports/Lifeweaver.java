...
public class Lifeweaver extends HeroSpecific {
    float healingDone;
    float critHits;
    float critKills;

    public Lifeweaver(String heroName, float critHits, float critKills, float deaths, float dmg, float kills, float assists, float healingDone, float elimsPerLife, Time time, int gamesPlayed, int gamesWon, int gamesLost) {
