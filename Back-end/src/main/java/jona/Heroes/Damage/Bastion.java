...
public class Bastion extends HeroSpecific {
    float critHits;
    float critKills;

    public Bastion(String heroName, float critHits, float critKills, float deaths, float dmg, float kills, float assists, float elimsPerLife, Time time, int gamesPlayed, int gamesWon, int gamesLost) {
