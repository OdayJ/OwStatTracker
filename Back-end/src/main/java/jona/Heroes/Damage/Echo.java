...
public class Echo extends HeroSpecific {
    float critHits;

    public Echo(String heroName, float critHits, float deaths, float dmg, float kills, float assists, float elimsPerLife, Time time, int gamesPlayed, int gamesWon, int gamesLost) {
