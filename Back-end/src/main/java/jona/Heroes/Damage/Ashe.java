...
public class Ashe extends HeroSpecific {
    float critHits;
    float critKills;

    public Ashe(String heroName, float critHits, float critKills, float deaths, float dmg, float kills, float assists, float elimsPerLife, Time time, int gamesPlayed, int gamesWon, int gamesLost) {
